...
help:
	...
	@echo "  make data-wizard [TICKERS=NVDA,MSFT] [TOP_N=10] Show prioritized data coverage unlocks"
	@echo "  make unlock-ladder [TICKERS=NVDA,MSFT] [TOP_N=10] Show one next-step unlock stage per ticker"
	@echo "  make unlock-summary [TICKERS=NVDA,MSFT] [TOP_N=10] Show grouped unlock priorities by holdings, theme, and sector ETF"
	@echo "  make command-bundles [TICKERS=NVDA,MSFT] [TOP_N=10] Show holdings-first local command bundles for prices, SEC, and peers"
	@echo "  make command-bundle-details [TICKERS=NVDA,MSFT] [TOP_N=10] Show ticker-level rows for the current local command bundles"
	@echo "  make command-bundle-runbook [TICKERS=NVDA,MSFT] [TOP_N=10] Show ordered runbook rows for the current local command bundles"
	@echo "  make bundle-prices [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the price bundle and its holdings-first scope when available"
	@echo "  make bundle-fundamentals [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the SEC fundamentals bundle"
	@echo "  make bundle-peers [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the peer-mapping bundle"
	@echo "  make bundle-prices-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue price bundle"
	@echo "  make bundle-fundamentals-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue SEC fundamentals bundle"
	@echo "  make bundle-peers-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue peer-mapping bundle"
	@echo "  make detail-prices [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the price bundle detail rows"
	@echo "  make detail-fundamentals [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the SEC fundamentals detail rows"
	@echo "  make detail-peers [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the peer-mapping detail rows"
	@echo "  make detail-prices-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue price detail rows"
	@echo "  make detail-fundamentals-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue SEC detail rows"
	@echo "  make detail-peers-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue peer detail rows"
	@echo "  make runbook-prices [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the price bundle runbook"
	@echo "  make runbook-fundamentals [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the SEC fundamentals runbook"
	@echo "  make runbook-peers [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the peer-mapping runbook"
	@echo "  make runbook-prices-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue price runbook"
	@echo "  make runbook-fundamentals-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue SEC runbook"
	@echo "  make runbook-peers-broader [TICKERS=NVDA,MSFT] [TOP_N=10] Show only the broader-queue peer runbook"
